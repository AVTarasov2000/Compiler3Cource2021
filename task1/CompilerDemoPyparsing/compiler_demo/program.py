...
def get_log_map(prog):
    ...
    while len(satck) != 0:
        ...
        if FuncNode.__name__ == curr_element.__class__.__name__:
            result_list.append(
                FuncInitLog(str(curr_element.type), curr_element.name, curr_element.col, curr_element.row))
        ...
        #     result_list.append(FuncInitLog(str(curr_element.type), curr_element.name, curr_element.col, curr_element.row))
        # elif CallNode.__name__ == curr_element.__class__.__name__:
        #     print(
